...
| WebRTC | bidirectional over a single connection | [RTCDataChannel](https://developer.mozilla.org/en/docs/Web/API/RTCDataChannel) | [wrtc](https://www.npmjs.com/package/wrtc) | JSON |
