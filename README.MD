...
| Worker | bidirectional, IPC (aka single connection) | :heavy_check_mark: | :heavy_check_mark: | 
| ProcessStdIO | one-way, new child process per call | | :heavy_check_mark: |
